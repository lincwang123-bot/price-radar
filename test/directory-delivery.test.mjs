...
test('non subscription service categories are not forced into account versus recharge',()=>{
 const directory=buildProductDirectory([{source:'goaihop-relay',products:[{product_id:'relay-example',name:'API 服务',currency:'CNY',offers:[quote('API 额度',10,'api')]}]},{source:'ldxp-goods',products:[{product_id:'gmail-account',name:'Gmail 邮箱',currency:'CNY',offers:[quote('Gmail 邮箱账号',5,'mail')]}]}]);
