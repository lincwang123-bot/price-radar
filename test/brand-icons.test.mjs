...
test('navigation category headings product rows and detail title share official brand image',async()=>{
  ...
  try {
    storeSnapshot(db,{source:'ldxp-goods',snapshotId:'brands',fetchedAt:now,products:[{productId:'claude-pro-month',name:'Claude Pro',platform:'Claude',currency:'CNY',offers:[{offerId:'brand-qa',title:'Claude Pro 代充 1个月',price:120,status:'in_stock',stockCount:2,currency:'CNY',url:'https://16688.com.cn/goods/brand-qa',capturedAt:now}]}]});
    await new Promise(r=>app.listen(0,'127.0.0.1',r));const base='http://127.0.0.1:'+app.address().port;
