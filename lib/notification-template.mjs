...
export const MAIL_STAGES = {
  ...
  published:['店铺报价已上线','你的店铺已有符合展示规则的有效报价，现已出现在 AirRadar 的产品目录中。','可以前往网站查看。报价和库存会随后续核验更新；售罄、过期或不符合规则的商品不会持续展示。'],
  ...
  submission_received:['你的提交已收到','感谢你帮助完善 AirRadar。你的反馈或合作信息已成功保存，我们会核查相关内容后再处理。','请保留提交编号。回复、采纳或其他处理结果会通过此邮箱通知；无需重复提交。'],
  ...
  reply:['你收到一条站方回复','AirRadar 已回复你的提交，请查看下方内容。','如果需要继续沟通，直接回复此邮件即可；请保留提交编号。'],
};
