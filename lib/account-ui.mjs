...
import {profileFields,profileForm} from './account-profile-ui.mjs';

export const accountAssets='<link rel="stylesheet" href="/assets/account.css"><script src="/assets/account.js" defer></script>';
export function accountContent(account,hasPassword,profile=null,next='/account'){
 return `<section class="reader-account" data-account-page data-profile-next="${esc(safeAccountReturn(next))}">
 ...
 ${hasPassword?profileForm(profile,safeAccountReturn(next)):''}
 ...
 </div><p class="reader-footnote">账号用于保存关注和提交店铺。注册不代表店铺已收录，也没有管理员权限。</p></section>`;
}
export function loginContent(mode,url){
 ...
 const copy=login?'用邮箱和密码登录，管理关注或提交店铺。':reset?'验证你的邮箱，然后设置一个新密码。':'验证邮箱、设置密码并填写联系资料。商家提交店铺须先注册，游客浏览报价无需注册。';
