...
const PUBLIC_PATHS = new Set(["/", "/index.html", "/product", "/alerts", "/sources", "/privacy", "/weekly", "/shop"]);
    ...
    record(req, statusCode, date = new Date()) {
      ...
      try {
        ...
        try{
          ...
          const quotePage=pathname==='/product'&&target.searchParams.has('id')||pathname==='/'&&target.searchParams.has('family');
