...
const files = Object.freeze({airadar:'airadar.png',chatgpt:'chatgpt.svg',claude:'claude.svg',gemini:'gemini.svg',grok:'grok.svg',x:'x.svg',suno:'suno.svg',cursor:'cursor.svg',perplexity:'perplexity.svg',notion:'notion.svg',manus:'manus.svg',microsoft:'microsoft.svg'});
...
export function brandMark(platform, cls = '') {
  ...
  const paths = key === 'relay' || key === 'api / 中转' ? '<rect x="3" y="3" width="18" height="7" rx="2"/><rect x="3" y="14" width="18" height="7" rx="2"/><path d="M7 6.5h.01M7 17.5h.01"/>' : key === 'mail' || key === '邮箱' ? '<rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 6 9 7 9-7"/>' : '<rect x="4" y="4" width="6" height="6" rx="1"/><rect x="14" y="4" width="6" height="6" rx="1"/><rect x="4" y="14" width="6" height="6" rx="1"/><rect x="14" y="14" width="6" height="6" rx="1"/>';
