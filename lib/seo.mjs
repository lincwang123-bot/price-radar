...
export function decorateSeo(html,url,db,status=200){
 ...
 let description=({'/':'比较 ChatGPT、Claude、Gemini 等 AI 订阅的公开报价、库存与历史价格，按交易渠道筛选并前往原店核验。本站不售卖账号，不提供交易担保。','/sources':'了解 AI 订阅报价的公开收录范围、更新时间、规格比较方法及购买前核验事项。','/alerts':'查看 AI 订阅公开报价变化提醒，结合历史记录与原店信息核验价格。','/privacy':'了解 AI 订阅价格雷达的访问统计口径、数据保留期限及主动投稿的隐私保护方式。'})[url.pathname]||'AI 订阅公开报价与历史记录参考。';
