...
export function decorateSeo(html,url,db,status=200){
 ...
 if(url.pathname==='/'){
  ...
  description='按品牌和产品浏览 AI 订阅、API 中转及邮箱接码的公开报价目录，选择产品后查看已收录的价格与规格。价格以原店结算页面为准。';
  ...
  if(directory){
   ...
   description=chosen?`查看${chosen.name}已收录的公开报价、交付规格与原店入口。价格与库存以店铺结算页面为准，本站不提供交易担保。`:`浏览${category.label}已收录的产品，选择具体产品后查看公开报价与规格。价格与库存以原店页面为准。`;
  }
 }
