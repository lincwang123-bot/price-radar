...
export function decorateSeo(html,url,db,status=200){
 ...
 if(url.pathname==='/'){
  ...
  description='按品牌浏览 AI 订阅、API 中转及邮箱的产品，直接查看多家店铺的公开报价、商品规格与交易平台，支持价格排序。价格以原店结算页面为准。';
