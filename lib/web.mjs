...
function sourceProductGroups(list, products) {
  ...
  const order = ["ChatGPT", "Claude", "Gemini", "Grok", "X", "Cursor", "Perplexity", "Notion AI", "Manus", "Microsoft", "API/CDK", "其他", "邮箱"];
...
async function routeRequest(req, res, { db, submissionsDb, admin, analytics, retention, xClaims, merchantUrlResolver }) {
  ...
  if (url.pathname==='/' && (retiredCatalogItem({key:url.searchParams.get('product')}) || ['verify','otp'].includes(url.searchParams.get('family')))) {
