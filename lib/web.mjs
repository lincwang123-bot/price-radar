...
async function routeRequest(req, res, { db, submissionsDb, admin, analytics, retention, xClaims }) {
  ...
  if (url.pathname === '/api/merchant-applications') return handleSubmissionRequest(req,res,submissionsDb,(_db,payload,options)=>{
    ...
    return createMerchantApplication(_db,payload,{...options,applicant:{accountId:account.id,email:account.email,phone:profile.phone,contact:profileContact(profile)}});
  });
...
export function createApp({ db, submissionsDb = null, analytics = null, adminOptions = {}, retentionOptions = {}, merchantXOptions = {} }) {
  ...
  const server = http.createServer((req, res) => {
    ...
    routeRequest(req, res, { db, submissionsDb, admin, analytics, retention, xClaims }).catch((error) => {
