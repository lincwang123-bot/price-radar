...
function homePage(db, url = new URL("http://localhost"),context={}) {
  ...
  if(!category){
    ...
    content='<a class="breadcrumb" href="/">'+icon('back')+'返回全部产品</a><div class="directory-intro"><h1>'+platformMark(category.key)+esc(category.label)+'</h1><p>点击产品，查看各家店铺报价。</p></div>'+categoryRow(category);
  }
