...
function directoryQuotePage(category,selected,url,{analytics,req,res,merchantBadges=[]}={}) {
  ...
  const activeDelivery=selected.deliveryEnabled ? (DIRECTORY_DELIVERIES.some(group=>group.kind===requestedDelivery)?requestedDelivery:initial.deliveries[0]?.kind||'unknown') : '';
