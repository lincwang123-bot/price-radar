...
function productPage(db, url) {
  ...
  return layout((product.name || id) + " · 报价", `
    <a class="breadcrumb" href="/?family=${source === "ldxp-goods" ? "other" : source === "goaihop-relay" ? "relay" : platformTone(product.platform)}">${icon("back")}返回产品分类</a>
