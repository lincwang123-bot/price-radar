...
function productPage(db, url) {
  ...
  const sourceLimitNotice = source === "priceai" && offers.length > 0 && hasUnpublishedOfferDetails(product)
    ? `<div class="offer-source-note" role="note"><strong>数据范围</strong><span>PriceAI 当前公开流仅提供该品类的 Top ${offers.length} 报价明细；第 ${offers.length + 1} 条及以后不在公开数据中，无法通过翻页展示。</span></div>`
    : "";
