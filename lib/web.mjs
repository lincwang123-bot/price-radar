...
<body>
  <header class="app-header"><div class="header-inner"><div class="header-main">
    ...
    <nav class="app-nav" aria-label="主导航">${nav("/", "home", "总览")}${nav("/following", "following", "我的关注")}${nav("/weekly", "weekly", "行情周报")}${nav("/alerts", "alerts", "价格提醒")}${nav("/submit", "submit", "反馈与合作")}</nav>
