...
export const PUBLIC_CATALOG_SOURCES=Object.freeze(['direct-shops','ldxp-goods','cardnav-official']);
export const retiredCatalogSource = source => typeof source==='string' && source!=='' && !PUBLIC_CATALOG_SOURCES.includes(source);
