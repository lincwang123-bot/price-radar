...
export const SPONSOR_RATE_VERSION='2026-09-09-v3';
...
export const SPONSOR_PLANS=Object.freeze([
 {key:'product',placement:'sponsored_product',label:'产品页',description:'指定产品的当页报价与分页之后',prices:{'7d':159,'14d':299,'28d':549}},
 {key:'category',placement:'sponsored_category',label:'分类页',description:'指定分类的产品列表之后',prices:{'7d':299,'14d':549,'28d':999}},
 {key:'home',placement:'sponsored_home',label:'首页',description:'首页产品导航和分类内容之后',prices:{'7d':449,'14d':849,'28d':1499}},
]);
