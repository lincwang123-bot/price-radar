...
export const ARTICLES = [
 ...
 },
 {
  ...
  actions:[source('/?family=chatgpt&product=chatgpt-plus','查看 ChatGPT Plus 当前报价'),source('/help/price-alerts','了解关注与价格提醒')],related:['/guides/chatgpt-plus-trial-day-pass','/guides/renewal-checklist','/guides/why-prices-differ'],
 },
 {
 ...
 },
 {
  ...
  sections:[
   ...
   section('radar','怎样使用本站的 Cursor 报价信息',`<p>本站将 ${link('/?family=cursor&amp;product=cursor-pro','Cursor Pro')}、${link('/?family=cursor&amp;product=cursor-pro-plus','Cursor Pro+')} 与 ${link('/?family=cursor&amp;product=cursor-ultra','Cursor Ultra')} 分开列出。先确定需要的计划，再查看期限、交付方式和币种，避免拿不同档位或不同付款周期凑出一个“半价”。</p><p>第三方报价可作为了解公开市场描述的线索，本站收录不代表 Cursor 授权销售，也不保证优惠资格和账号持续可用。购买入口应优先核对官方页面。发现商品名称、期限或链接不一致，可通过 ${link('/submit?type=feedback','数据反馈')} 提交原链接；不要提交账号密码或验证码。</p><p>需要整理下一次续费安排时，可参考 ${link('/guides/renewal-checklist','购买与续费前核对清单')}。只有先查明账号、计划、费用和来源，价格比较才有意义。</p>`),
...
export function productGuideLinks(productKey=''){
 ...
 const buyingGuide={'chatgpt-plus':['/guides/chatgpt-plus-delivery','ChatGPT Plus 交付方式怎么选'],'claude-pro':['/guides/claude-pro-buying','Claude Pro 购买条件怎么核对'],'gemini-pro':['/guides/gemini-membership-options','Google AI Pro 交付与家庭权益'],'gemini-activation-service':['/guides/gemini-membership-options','激活服务与完整订阅的区别'],'cursor-pro':cursorGuide,'cursor-pro-plus':cursorGuide,'cursor-ultra':cursorGuide,'cursor-account':cursorGuide}[productKey]||['/guides/why-prices-differ','为什么价格不同'];
