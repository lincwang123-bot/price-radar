...
export function productGuideLinks(productKey=''){
 const buyingGuide={'chatgpt-plus':['/guides/chatgpt-plus-delivery','ChatGPT Plus 交付方式怎么选'],'claude-pro':['/guides/claude-pro-buying','Claude Pro 购买条件怎么核对'],'gemini-pro':['/guides/gemini-membership-options','Google AI Pro 交付与家庭权益'],'gemini-activation-service':['/guides/gemini-membership-options','激活服务与完整订阅的区别']}[productKey]||['/guides/why-prices-differ','为什么价格不同'];
 return `<aside class="product-guide-links" aria-label="选购与使用指南"><span>选购与使用指南</span><a href="/help/compare-prices">如何比较这些报价</a>${link(...buyingGuide)}<a href="/guides/renewal-checklist">购买与续费前核对</a></aside>`;
}
