...
const deliveryEnabled = definition => !['relay','mail','other'].includes(definition.category) && !/credits|service|claim-link/.test(definition.key);

export const DIRECTORY_CATEGORIES = Object.freeze([
  ['chatgpt', 'ChatGPT'], ['claude', 'Claude'], ['gemini', 'Gemini'],
  ['grok', 'Grok'], ['x', 'X'], ['relay', 'API / 中转'], ['mail', '邮箱'],
...
function definitionFor(list, product, offer) {
  if (retiredCatalogItem(product) || retiredCatalogItem(offer)) return undefined;
...
function quoteEligible(list, product, offer) {
  if (retiredCatalogItem(product) || retiredCatalogItem(offer)) return false;
